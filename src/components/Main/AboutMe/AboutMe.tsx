			...
			<div className='profile-container'>
				<div className='profile-box'>
					...
					<div className='profile-img_box'>
						<img src='image/portFolio-logo.png' width={300} height={300} alt='프로필 이미지' className='profile-img' />
					</div>
					<div className='icons-box'>
						<a href='mailto:jackgg12322@gmail.com' className='icon-item' id='gmail' target='_blank' aria-label='Gmail'>
							<SiGmail />
						</a>
						<a
				...
				<div className='profile-info_container'>
					...
					<div className='profile-text'>
						안녕하세요.
						<br />
						어린 시절 호기심에 오픈소스로 유틸리티 프로그램을 개발하여 친구들에게 <br />
						공유하고 사용하는데 재미를 느낀 경험이 있어 개발자를 꿈꾸게 되었습니다. 현재는 프론트엔드 개발자가 되고자
						꾸준히 학습한 내용들을 정리하여
						<a className='profile-text_link' href='https://velog.io/@jackgg12322/posts' target='_blank'>
							개인 블로그
						</a>
						에 <br />
						작성중입니다. 항상 배우는 자세로 임하고 제 역량을 발휘하여 회사에 많은 <br />
						기여를 하는 개발자가 되겠습니다. 감사합니다.
					</div>
				</div>
			</div>
		</section>
